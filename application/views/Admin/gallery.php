    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i>Gallery</h1>
          <p>Gallery Manage</p>
        </div>
          ...
          <div class="tile">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">
              Add Imaage
                  ...
                  ?>
                          <div id="deltMessage" class="alert alert-danger " role="alert">
        ...
        {?> 
                <tbody>
                  <tr>
                    ...
                    <td><img class="img-responsive" src="<?php echo base_url('./public/uploads/gallery/').'/'. $row->uplode_file ?>" 
                    ...
                    <a href='<?php echo site_url('Admin/delete_img_cont').'/'.$row->id ?>' onclick="return confirm('Do you really want to delete this records?')"><i class="fa fa-trash fa-lg"></i></a>
                    </td>
                  </tr>
                </tbody>
        <?php 
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <!-- Modal body -->
      <form method="POST" action="<?php echo site_url('Admin/gallery_uplode'); ?>" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Descrip</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" required="" name="descrip" id="descrip">
              </div>
            </div>
            <div class="form-group row">
          ...
          <input type="submit" name="submit" value="Uplode" class="btn btn-primary" >
        </div>
      </form>
    </div>
    </div>        
